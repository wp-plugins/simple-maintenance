...
For more information please check the [Simple Maintenance Plugin](http://wphowto.net/simple-maintenance-plugin-wordpress-595) documentation page
...
For screenshots please check the [Simple Maintenance Plugin](http://wphowto.net/simple-maintenance-plugin-wordpress-595) page
